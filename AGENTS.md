...
When starting a project from this template, replace placeholder identity in STATUS.md with the actual repository and branch. Never copy a template's completion claims into a new project.
